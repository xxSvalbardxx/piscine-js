...
export function getActive(){
    var rslt = [];
    var yes = Array.from(document.getElementsByClassName("active"));
    var no = Array.from(!document.querySelectorAll('classical:not(.active)'));
    rslt.push(yes);
    rslt.push(no);
...
export function getBonannoPisano(){
    ...
    var no = Array.from(document.querySelectorAll('active:not(#BonannoPisano)'));
    rslt.push(yes);
    rslt.push(no);
